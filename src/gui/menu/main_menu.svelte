...
<section>
	<svelte:component this={current_screen}/>
</section>
	...
	<wired-card class="main_menu" elevation="5">
		<div>
			{#if display_lobby_creation}
				...
				<label for="lobby-code-input">What Lobby Code do you want for your game? <br />
				<em>Your friends use this to join you!</em></label>
				<wired-card>
			...
			{:else}
				...
				<!-- Home -->
			<h2>Welcome to omok.io!</h2>
			<wired-button elevation="2" on:click={current_screen.create_lobby}>Create Lobby</wired-button>
			<wired-button elevation="2" on:click={current_screen.join_lobby}>Join Lobby</wired-button>
			<wired-button elevation="2" on:click={current_screen.ai_lobby}>Play vs Computer</wired-button>
			<wired-button elevation="2" on:click={current_screen.local_lobby}>Play locally</wired-button>
			{/if}
		</div>
	</wired-card>
{/if}
